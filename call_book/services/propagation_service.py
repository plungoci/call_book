...
_BAND_DEFAULTS = {
    "2200m": PROPAGATION_GROUND_WAVE,
    "630m": PROPAGATION_GROUND_WAVE,
    "160m": PROPAGATION_GROUND_WAVE,
    "80m": PROPAGATION_NVIS,
    "60m": PROPAGATION_NVIS,
    "40m": PROPAGATION_NVIS,
    "30m": PROPAGATION_F2,
    "20m": PROPAGATION_F2,
    "17m": PROPAGATION_F2,
    "15m": PROPAGATION_F2,
    "12m": PROPAGATION_F2,
    "10m": PROPAGATION_F2,
    "6m": PROPAGATION_SPORADIC_E,
    "4m": PROPAGATION_TROPOSPHERIC,
    "2m": PROPAGATION_DIRECT,
    "1.25m": PROPAGATION_DIRECT,
    "70cm": PROPAGATION_DIRECT,
    "33cm": PROPAGATION_DIRECT,
    "23cm": PROPAGATION_DIRECT,
    "13cm": PROPAGATION_DIRECT,
    "9cm": PROPAGATION_DIRECT,
    "6cm": PROPAGATION_DIRECT,
    "3cm": PROPAGATION_DIRECT,
    "1.25cm": PROPAGATION_DIRECT,
}
...
def suggest_propagation_mode(
    ...
    mode: str | None = None,
    repeater_selected: bool = False,
    satellite_selected: bool = False,
) -> str:
    ...
    return _BAND_DEFAULTS.get(normalized_band or "", PROPAGATION_UNKNOWN)
